...
export function getIconPaths(dtype, color) {
  ...
  const icons = {
    ...
    'rak-gw':     `<rect x="5" y="10" width="24" height="16" rx="3" fill="${c}18" stroke="${c}" stroke-width="2"/><line x1="17" y1="3" x2="17" y2="10" stroke="${c}" stroke-width="2"/><line x1="12" y1="3" x2="17" y2="10" stroke="${c}" stroke-width="1.5"/><line x1="22" y1="3" x2="17" y2="10" stroke="${c}" stroke-width="1.5"/><rect x="9" y="14" width="5" height="7" rx="1" fill="${c}"/><rect x="20" y="14" width="5" height="7" rx="1" fill="${c}" opacity=".4"/>`,
