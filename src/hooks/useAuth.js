...
export function AuthProvider({ children }) {
  ...
  // reset-password links; an invite link just looks like a normal
  // 'SIGNED_IN'. This lets ResetPasswordPage tell the two apart and show
  // "reset your password" vs "welcome, set up your account" accordingly.
  ...
  return (
    <AuthContext.Provider value={{ user, loading, profile, isAdmin: !!profile?.is_admin, isExpired, lastAuthEvent }}>
      {children}
